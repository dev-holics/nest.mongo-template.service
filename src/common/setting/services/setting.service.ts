...
export class SettingService implements ISettingService {
	...
	async findAll(
		...
		return this.settingRepository.findAll<SettingDocument>(where, options);
	}
	...
	async findOneById(
		...
		return this.settingRepository.findOneById<SettingDocument>(_id, options);
	}
	...
	async findOneByName(
		...
		return this.settingRepository.findOne<SettingDocument>({ name }, options);
	}

	async getTotal(where?: Record<string, any>): Promise<number> {
		return this.settingRepository.getTotal(where);
	}
	...
	async deleteOne(
		...
		return this.settingRepository.deleteOne(where, options);
	}
