...
export class AuthApiService implements IAuthApiService {
	...
	async findAll(
		...
		return this.authApiRepository.findAll<AuthApiDocument>(where, {
			...options,
			select: {
				name: 1,
				key: 1,
	...
	async findOneById(
		...
		return this.authApiRepository.findOneById<AuthApiDocument>(_id, options);
	}
	...
	async findOne(
		...
		return this.authApiRepository.findOne<AuthApiDocument>(where, options);
	}
	...
	async findOneByKey(
		...
		return this.authApiRepository.findOne<AuthApiDocument>({ key }, options);
	}

	async getTotal(where?: Record<string, any>): Promise<number> {
		return this.authApiRepository.getTotal(where);
	}
	...
	async updateHashById(
		...
		const authApi: AuthApiDocument = await this.authApiRepository.findOneById(
			_id,
		);
	...
	async deleteOne(
		...
		return this.authApiRepository.deleteOne(where, options);
	}
