...
describe('SettingService', () => {
	...
	describe('findAll', () => {
		...
		it('should be success with options limit and skip', async () => {
			const result = await settingService.findAll({}, { limit: 1, skip: 0 });
			jest
				.spyOn(settingService, 'findAll')
				.mockImplementation(async () => result);

			expect(await settingService.findAll({}, { limit: 1, skip: 0 })).toBe(
				result,
			);
		});
	...
	describe('updateOneById', () => {
		...
		it('should be success', async () => {
			...
			jest
				.spyOn(settingService, 'updateOneById')
				.mockImplementation(async () => result);
	...
	describe('deleteOne', () => {
		...
		it('should be success', async () => {
			...
			expect(await settingService.deleteOne({ _id: setting._id })).toBe(result);
	...
	describe('convertValue', () => {
		...
		it('should be success', async () => {
			...
			jest
				.spyOn(settingService, 'convertValue')
				.mockImplementation(async () => result);
