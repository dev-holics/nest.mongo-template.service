...
describe('DatabaseOptionsService', () => {
	...
	describe('createMongooseOptions', () => {
		it('should be called', async () => {
			const test = jest.spyOn(databaseOptionsService, 'createMongooseOptions');
		...
		it('should be success', async () => {
			...
			jest
				.spyOn(databaseOptionsService, 'createMongooseOptions')
				.mockImplementation(() => options);

			expect(databaseOptionsService.createMongooseOptions()).toBe(options);
		});
