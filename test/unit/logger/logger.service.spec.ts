...
describe('LoggerService', () => {
	...
	describe('warning', () => {
		...
		it('should be success', async () => {
			...
			jest.spyOn(loggerService, 'warning').mockImplementation(() => result);
	...
	describe('raw', () => {
		...
		it('should be success', async () => {
			...
			expect(loggerService.raw({ level: loggerLevel, ...logger })).toBe(result);
		});
		...
		it('should be success complete', async () => {
			...
			expect(loggerService.raw({ level: loggerLevel, ...loggerComplete })).toBe(
				result,
			);
		});
	});
