...
describe('AuthApiService', () => {
	...
	describe('createRaw', () => {
		it('should return an success', async () => {
			...
			jest
				.spyOn(authApiService, 'createRaw')
				.mockImplementation(async () => result);
	...
	describe('findOneById', () => {
		it('should return an success', async () => {
			...
			jest
				.spyOn(authApiService, 'findOneById')
				.mockImplementation(async () => result);

			expect(await authApiService.findOneById(`${authApi._id}`)).toBe(result);
		});
	});
	...
	describe('findOne', () => {
		it('should return an success', async () => {
			...
			jest
				.spyOn(authApiService, 'findOne')
				.mockImplementation(async () => result);

			expect(await authApiService.findOne({ _id: authApi._id })).toBe(result);
		});
	});
	...
	describe('findOneByKey', () => {
		it('should return an success', async () => {
			...
			jest
				.spyOn(authApiService, 'findOneByKey')
				.mockImplementation(async () => result);
	...
	describe('inactive', () => {
		it('should return an success', async () => {
			...
			jest
				.spyOn(authApiService, 'inactive')
				.mockImplementation(async () => result);

			expect(await authApiService.inactive(`${authApi._id}`)).toBe(result);
		});
	});
	...
	describe('findAll', () => {
		it('should return an success', async () => {
			...
			jest
				.spyOn(authApiService, 'findAll')
				.mockImplementation(async () => result);

			expect(await authApiService.findAll({}, { limit: 1, skip: 1 })).toBe(
				result,
			);
		});
	...
	describe('updateOneById', () => {
		it('should return an success', async () => {
			...
			jest
				.spyOn(authApiService, 'updateOneById')
				.mockImplementation(async () => result);
	...
	describe('updateHashById', () => {
		it('should return an success', async () => {
			...
			jest
				.spyOn(authApiService, 'updateHashById')
				.mockImplementation(async () => result);
	...
	describe('deleteOneById', () => {
		it('should return an success', async () => {
			...
			jest
				.spyOn(authApiService, 'deleteOneById')
				.mockImplementation(async () => result);

			expect(await authApiService.deleteOneById(`${authApi._id}`)).toBe(result);
		});
	});
	...
	describe('deleteOne', () => {
		it('should return an success', async () => {
			...
			jest
				.spyOn(authApiService, 'deleteOne')
				.mockImplementation(async () => result);

			expect(await authApiService.deleteOne({ _id: `${authApi._id}` })).toBe(
				result,
			);
		});
	});
	...
	describe('createKey', () => {
		it('should return an success', async () => {
			...
			jest
				.spyOn(authApiService, 'createKey')
				.mockImplementation(async () => result);
	...
	describe('createEncryptionKey', () => {
		it('should return an success', async () => {
			...
			jest
				.spyOn(authApiService, 'createEncryptionKey')
				.mockImplementation(async () => result);
	...
	describe('createSecret', () => {
		it('should return an success', async () => {
			...
			jest
				.spyOn(authApiService, 'createSecret')
				.mockImplementation(async () => result);
	...
	describe('createPassphrase', () => {
		it('should return an success', async () => {
			...
			jest
				.spyOn(authApiService, 'createPassphrase')
				.mockImplementation(async () => result);
	...
	describe('createHashApiKey', () => {
		it('should return an success', async () => {
			...
			const result: string = await authApiService.createHashApiKey(key, secret);
			jest
				.spyOn(authApiService, 'createHashApiKey')
				.mockImplementation(async () => result);

			expect(await authApiService.createHashApiKey(key, secret)).toBe(result);
		});
	});
	...
	describe('validateHashApiKey', () => {
		it('should return an success', async () => {
			...
			jest
				.spyOn(authApiService, 'validateHashApiKey')
				.mockImplementation(async () => result);
		...
		it('should return an failed', async () => {
			...
			expect(
				await authApiService.validateHashApiKey(hashFormRequest, hashWrong),
			).toBe(result);
		});
	});
	...
	describe('decryptApiKey', () => {
		it('should return an success', async () => {
			...
			jest
				.spyOn(authApiService, 'decryptApiKey')
				.mockImplementation(async () => result);
	...
	describe('encryptApiKey', () => {
		it('should return an success', async () => {
			...
			jest
				.spyOn(authApiService, 'encryptApiKey')
				.mockImplementation(async () => result);
	...
	describe('createBasicToken', () => {
		it('should return an success', async () => {
			...
			jest
				.spyOn(authApiService, 'createBasicToken')
				.mockImplementation(async () => result);
	...
	describe('validateBasicToken', () => {
		it('should return an success', async () => {
			...
			jest
				.spyOn(authApiService, 'validateBasicToken')
				.mockImplementation(async () => result);
		...
		it('should return an failed', async () => {
			...
			expect(
				await authApiService.validateBasicToken(basicToken, clientSecret2),
			).toBe(result);
		});
	});
